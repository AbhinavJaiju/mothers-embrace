    ...
    <div className="h-90 sm:h-90 xl:h-120 2xl:h-150">
     <Carousel>
        <div className="relative flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white">
          ...
          <div className="absolute inset-0 mx-4 my-auto flex h-64 flex-col items-center justify-center rounded-lg text-red-500 sm:text-gray-100 bg-white/50 px-4 pb-6 text-center sm:mx-6 sm:my-4 sm:h-full sm:bg-transparent">
